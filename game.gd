...
func debug_populate():
	...
	var cell7 = $HexGrid.create_cell(2,0)
	cell7.init_resource(Globals.ParticleType.RESOURCE_AMINO_LYS)
	
	var cell8 = $HexGrid.create_cell(3,0)
	cell8.init_toxin(Globals.ToxinType.LYE)
